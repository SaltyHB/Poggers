if isfile("Raito-Hub-Language") then
    _G.Language = readfile("Raito-Hub-Language")
end
...
if SuperFastMode then 
    ...
    cac=wait
                    ...
                    --------------------------------------------------------------------
                    local Settings = Raito:AddTab(SettingsTABB,"10734950309")
                    local Main = Raito:AddTab(HomeTABB,"10723407389")
                    local Combat = Raito:AddTab(CombatTABB,"10734975692")
                    ---Stats
                    local Stats = Raito:AddTab(StatsTABB,"10709773755")
                    ...
                    -- Finish Of Stats
                    local Teleport = Raito:AddTab(TeleportTABB,"10734886004")
                    local Dungeon = Raito:AddTab(DungeonTABB,"10734962068")
                    local Fruit = Raito:AddTab(FruitTABB,"10709761889")
                    local Shop = Raito:AddTab(ShopTABB,"10734952479")
                    local Misc = Raito:AddTab(OthersTABB,"10723425615")
                    --------------------------------------------------------------------
                    local GameTime = math.floor(workspace.DistributedGameTime+0.5)
                    local Hour = math.floor(GameTime/(60^2))%24
                    local Minute = math.floor(GameTime/(60^1))%60
                    ...
                    selecllele = Settings:AddDropdown(SelectLanguage,"English",{"English","Turkish","Arabic","Vietnamse","Urdu"},function(value)
                        _G.Language = value
                        writefile("Raito-Hub-Language", _G.Language)
                    end)
