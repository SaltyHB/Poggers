...
if SuperFastMode then 
    ...
    cac=wait
                    ...
                    local Stats = Main:AddNLabel("  Hours : "..Hour.." Minutes : "..Minute.." Seconds : "..Second.." \n  Fps : "..Fps.." Ping : "..Ping.." \n  Exploit : "..identifyexecutor())
                    ...
                    function UpdateStats()
                        ...
                        local Ping = game:GetService("Stats").Network.ServerStatsItem["Data Ping"]:GetValueString()
                        local Fps = workspace:GetRealPhysicsFPS()
                        Stats:Set2("  Hours : "..Hour.." Minutes : "..Minute.." Seconds : "..Second.." \n  Fps : "..Fps.." Ping : "..Ping.." \n  Exploit : "..identifyexecutor().." Username : "..game.Players.LocalPlayer.Name)
                    end
                    ...
                    Settings:AddToggle("Double Quest",_G.Settings.KillExtra,function(value)
                        _G.KillExtra = value
                    ...
                    Settings:AddDropdown("Select Attack Delay",_G.Settings.SelectedDelay,{"Slow","Fast","Extreme"},function(value)
                    ...
                    Main:AddDropdown("Select Mode",_G.Settings.SelectMode,{"Normal Mode","Nearest Mode","Fruit Mastery Mode","Gun Mastery Mode"},function(value)
                        _G.SelectMode = value
