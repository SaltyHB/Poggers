...
local Window = OrionLib:MakeWindow({Name = "Raito Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Raito Hub", IntroEnabled = true, IntroText = "Raito Hub - Qrto",IntroIcon = "rbxassetid://12517360827", Icon = "rbxassetid://10472045394" })
...
Dispenser:AddButton({
	Name = "Join Script Discord Server",
	Callback = function()
    setclipboard("https://discord.gg/raitohub")
  	end    
})
Dispenser:AddButton({
	Name = "Join Developer Discord Server",
	Callback = function()
    setclipboard("https://discord.gg/GPRhMR7NvA")
  	end    
})
Dispenser:AddButton({
