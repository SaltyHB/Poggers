-- I DONT CARE SKIDDERS MY SITE GOT BLOCKED
function thisCode()
    ...
    local AllowRunService = _G.FarmChest
    local AllowRunServiceBind = Instance.new("BindableFunction")
    
    task.spawn(function()
        while true do
            if AllowRunService == _G.FarmChest then
 ...
 if not game.Players.LocalPlayer.Backpack:FindFirstChild("Fist of Darkness") and not game.Players.LocalPlayer.Character:FindFirstChild("Fist of Darkness") then
