 ...
 spawn(function()
    ...
    until not _G.AutoFarm or not v.Parent or v.Humanoid.Health == 0 or not game.Workspace.Enemies:FindFirstChild(v.Name)
                    ...
                    spawn(function()
                        ...
                        Settings:AddDropdown(SADELAY,_G.Settings.SelectedDelay,{SLOW,"Normal",FAST},function(value)
...
task.spawn(function()
	while wait() do 
        ...
        KeyLibrary.Set({
            ...
            AuthType = "clientid",
            EncryptionKey = "rairriairiairiria",
        ...
        top_frame.BorderColor3 = Color3.fromRGB(15,15,14)
        ...
        function Check()
                ...
                local o_data = KeyLibrary.VerifyKey(KeyInput.Text) or KeyLibrary.VerifyPremiumKey(KeyInput.Text) or KeyLibrary.VerifyDefaultKey(KeyInput.Text)
        ...
        GetKey.MouseButton1Click:Connect(function()
            ...
            GetKey.Text = "Copied ✅"
            setclipboard(KeyLibrary:GetKey())
            KeyInput.Text = KeyLibrary:GetKey()
            wait(1)
            GetKey.TextColor3 = Color3.new(1, 1, 1)
            GetKey.Text = "Get Key"
        end)
